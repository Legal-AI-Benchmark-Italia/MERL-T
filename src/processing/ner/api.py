...
async def delete_entity(
    ...
    try:
        ...
        try:
            from ner.annotation.app import check_entity_type_in_use
...
async def import_annotations(annotations_file: str = Body(..., description="Path to annotations file")):
    ...
    try:
        from ner.utils.converter import convert_annotations_to_ner_format
...
def start_server():
    ...
    uvicorn.run("ner.api:app", host=host, port=port, workers=workers)
