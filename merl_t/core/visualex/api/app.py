...
from merl_t.core.visualex.tools.config import HISTORY_LIMIT, RATE_LIMIT, RATE_LIMIT_WINDOW
from merl_t.core.visualex.tools.norma import Norma, NormaVisitata
from merl_t.core.visualex.services.brocardi_scraper import BrocardiScraper
from merl_t.core.visualex.services.normattiva_scraper import NormattivaScraper
from merl_t.core.visualex.services.eurlex_scraper import EurlexScraper
from merl_t.core.visualex.services.pdfextractor import extract_pdf
from merl_t.core.visualex.tools.sys_op import WebDriverManager
from merl_t.core.visualex.tools.urngenerator import complete_date_or_parse, urn_to_filename
from merl_t.core.visualex.tools.treextractor import get_tree
from merl_t.core.visualex.tools.text_op import format_date_to_extended, parse_article_input
    ...
    async def export_pdf(self):
        try:
            ...
            if extracted_pdf_path != pdf_path:
                def copy_file(merl_t, dst):
                    with open(merl_t, 'rb') as fmerl_t, open(dst, 'wb') as fdst:
                        fdst.write(fmerl_t.read())
